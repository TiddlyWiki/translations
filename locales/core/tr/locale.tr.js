...
tagPrompt: "Boşluklarla ayrılmış tip etiketleri [[çift köşeli parantez kullanın]] gerekirse, ya da var olana ekle",
...
step1Html: "Sunucusunun türünü belirtin: <select name='selTypes'><option value=''>Seç...</option></select><br>URL veya dosya yolunu buraya gir: <input type='text' size=50 name='txtPath'><br>...veya dosyayı bulmak için: <input type='file' size=50 name='txtBrowse'><br><hr>...veya önceden tanımlanmış bir linki seçin: <select name='selFeeds'><option value=''>Seç...</option></select>",
openLabel: "aç",
...
step2Html: "Bir çalışma alanı adını girin: <input type='text' size=50 name='txtWorkspace'><br>...ya da bir çalışma alanı seçin: <select name='selWorkspace'><option value=''>Seç...</option></select>",
cancelLabel: "iptal",
...
step3Html: "<input type='hidden' name='markList'></input><br><input type='checkbox' checked='true' name='chkSync'>Bu sunucuya bağlı bu tiddleri tutun, böylece daha sonraki değişiklikleri senkronize edebilirsiniz</input><br><input type='checkbox' name='chkSave'>Bu serverdaki detayları 'systemServer' tiddler kaydet:</input> <input type='text' size=25 name='txtSaveTiddler'>",
...
step1Html: "TiddlyWiki çekirdek kodunu son sürüme yükseltmek üzeresin (from <a href='%0' class='externalLink' target='_blank'>%1</a>). İçeriğiniz güncelemeye karşı korunmuş olacaktır.<br><br>Unutmayın, çekirdek güncellemeleri eski eklentileri etkileyebilir olduğu bilinmekte. Yükseltilen dosya ile sorun yaşarsanız bkz. <a href='http://www.tiddlywiki.org/wiki/CoreUpgrades' class='externalLink' target='_blank'>http://www.tiddlywiki.org/wiki/CoreUpgrades</a>",
...
step2Html_restore: "Bu TiddlyWiki zaten çekirdek kodunun en son versiyonu kullanıyor görünüyor (%0).<br><br>Yükseltmeye devam edebilirsin yine de çekirdek kodunun bozulmuş veya hasar görmemiş olduğundan emin olun",
...
currentlySyncing: "<div>Şimdi senkronize edilen <span class='popupHighlight'>'%0'</span> to:</"+"div><div>host: <span class='popupHighlight'>%1</span></"+"div><div>çalışma alanı: <span class='popupHighlight'>%2</span></"+"div>", // Note escaping of closing <div> tag
